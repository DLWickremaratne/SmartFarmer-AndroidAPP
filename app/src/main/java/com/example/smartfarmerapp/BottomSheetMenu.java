...
public class BottomSheetMenu extends BottomSheetDialogFragment {
    ...
    CardView cv_test,cv_logout,cv_delete;
    FirebaseAuth mAuth;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final String cureentid = user.getUid();
                                ...
                                reference.delete()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Query query = df.orderByChild("uid").equalTo(cureentid);
    ...
    private void logout() {
        ...
        .setPositiveButton("Logout", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                mAuth.signOut();
                startActivity(new Intent(getActivity(),farmerLoginActivity.class));
