...
import com.example.smartfarmerapp.SCAdminCategoryActivity;
...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton = findViewById(R.id.seller_rejister_btn);
                                ...
                                rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                loadingBar.dismiss();
                                                Toast.makeText(SellerRegistrationActivity.this, "You are Registered Succesfully", Toast.LENGTH_SHORT).show();

                                                Intent intent =new Intent(SellerRegistrationActivity.this, SCAdminCategoryActivity.class);
